...
public class CPTreeDataModel extends AjaxTreeModel {
	 ...
	 * Constructor
	 * 
	 * @param orgaIdentifyer The identifier of the organization element of the imsmanifest file.
	 * @param rootNodeId The root node id of the ext-js tree. (We use an md5 hash to make sure it doesn't contain any weird characters.)
	 */
